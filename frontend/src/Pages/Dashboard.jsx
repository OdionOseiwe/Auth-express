...
const Dashboard = () => {
  ...
  return (
    ...
    rounded-lg shadow-2xl border border-gray-800">
      ...
      <div className='space-y-6'>
        ...
        transition={{delay:0.4}}>
          ...
          <p className='text-gray-300'>
            <span
            className='font-semibold'>joined:</span>
            {
          ...
          <p className='text-gray-300'>
            ...
            {
              user.lastLogin ? formateDate(user.lastLogin):"You just signed up"
            }
          </p>
        </motion.div>
      </div>
      ...
      font-bold rounded-lg hover:from-green-600 to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500
